...
class JSONData {
    val api_url = "https://digimon-api.vercel.app/api/digimon"
        //"https://megaman-robot-masters.herokuapp.com/"
...
//            val resultsArray = jsonObject.getJSONArray("")
            ...
            for (i in 0 until resultsArray.length()){
                ...
                val posterURL = movieObject.getString("img")
                val rating = movieObject.getString("level")
