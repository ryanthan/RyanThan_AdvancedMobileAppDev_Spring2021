...
- (void)viewWillAppear:(BOOL)animated {
	...
	self.itemList=[dictionary objectForKey:self.title]; //assigns the items for the choosen store to itemList
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text=[self.itemList objectAtIndex:indexPath.row]; //sets the text of the cell with the row being requested
